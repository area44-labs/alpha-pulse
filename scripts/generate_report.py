"""Generate Report Script for VN VN Invest v2.
...
def main():
    parser = argparse.ArgumentParser(description="VN VN Invest Report Generator v2")
    parser.add_argument(
        "--update",
        action="store_true",
    ...
    logger.info("Starting VN VN Invest Report Generator v2 (update=%s)...", args.update)
