  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-tab-active-border data-active:bg-tab-active-bg data-active:text-foreground",
